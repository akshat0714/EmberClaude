...
**No Cesium Ion / no API keys.** Imagery = CARTO dark basemap (keyless) with automatic fallback to Cesium's bundled offline NaturalEarthII. Everything else is generated.
